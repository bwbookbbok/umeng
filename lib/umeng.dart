...
typedef void OnPushCustomMessageCallback(dynamic obj);

class Umeng {
  static const String pluginNamePrefix = "";
  ...
  static const MethodChannel _methodChannel =
      const MethodChannel('flutter_umeng_20200703_channel');

  static const EventChannel _eventChannel =
      const EventChannel('flutter_umeng_20200703_channel/event');
  ...
  static addPushCustomMessageCallback(
    ...
    if (_eventChannel != null) {
      _eventChannel
          ...
          .listen(onPushCustomMessageCallback);
    }
  }
  ...
  static Future<dynamic> setAlias(String alias, String type) async {
    Map<String, dynamic> args = {'alias': alias, 'type': type};
    return await _methodChannel.invokeMethod('setAlias', args);
  }
